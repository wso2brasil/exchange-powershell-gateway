...
function initThrottlePolicies() {
    ...
    future<()> initSubscriptionDefaultPolicyFtr = start initSubscriptionDefaultPolicy();
...
function getDeployedPolicies() returns map<boolean> {
    return { "50PerMin":true,"20PerMin":true,"10PerMin":true,"Gold":true,"Silver":true,"Bronze":true,"Unauthenticated":true,"Default":true,"50kPerMin":true,"20kPerMin":true,"10kPerMin":true };
}